...
export const translations = {
  vi: {
    ...
    'create.styleTitle': 'Chọn phong cách',
    'create.generateButton': 'Tạo 8 ứng viên sticker',
    ...
    'job.stage.validating': 'Đang kiểm tra ảnh đầu vào',
    'job.stage.canonicalizing': 'Đang khóa nhận dạng và phong cách',
    'job.stage.generating': 'Đang tạo 8 ứng viên sticker',
    'job.stage.splitting': 'Đang tách từng sticker',
    'job.stage.qualityChecking': 'Đang kiểm tra chất lượng',
    ...
    // Preview Screen
    'preview.pillDemo': '{{count}} STICKER · KIỂM DUYỆT MOCK',
    'preview.pillReal': '{{count}} STICKER · ĐÃ KIỂM DUYỆT',
    'preview.title': 'Chọn những sticker\nbạn thật sự thích',
    'preview.body': 'Mặc định chọn mọi kết quả đạt chuẩn. Chạm từng sticker để bỏ hoặc chọn lại.',
    ...
    'preview.regenerateButton': 'Tạo lại toàn bộ pack',
    'preview.confirmRegenerateTitle': 'Tạo lại toàn bộ?',
    'preview.confirmRegenerateBody': 'Một job mới sẽ tạo 8 ứng viên từ cùng ảnh nguồn. Các lựa chọn hiện tại chưa được lưu.',
    'preview.stay': 'Ở lại',
    'preview.regenerate': 'Tạo lại',
    'preview.loadingTitle': 'Chuẩn bị bản xem trước',
    'preview.loadingBody': 'Đang tải 6–8 kết quả đã qua kiểm duyệt…',
  ...
  en: {
    ...
    'create.styleTitle': 'Choose a style',
    'create.generateButton': 'Generate 8 sticker candidates',
    ...
    'job.stage.validating': 'Validating the source image',
    'job.stage.canonicalizing': 'Locking identity and style',
    'job.stage.generating': 'Generating 8 sticker candidates',
    'job.stage.splitting': 'Splitting individual stickers',
    'job.stage.qualityChecking': 'Checking output quality',
    ...
    // Preview Screen
    'preview.pillDemo': '{{count}} STICKERS · MOCK MODERATED',
    'preview.pillReal': '{{count}} STICKERS · MODERATED',
    'preview.title': 'Select the Stickers\nYou Really Like',
    'preview.body': 'All passing results are selected by default. Tap a sticker to toggle it.',
    ...
    'preview.regenerateButton': 'Regenerate the entire pack',
    'preview.confirmRegenerateTitle': 'Regenerate All?',
    'preview.confirmRegenerateBody': 'A new job will generate 8 candidates from the same source photo. Unsaved selections will be lost.',
    'preview.stay': 'Stay',
    'preview.regenerate': 'Regenerate',
    'preview.loadingTitle': 'Preparing Preview',
    'preview.loadingBody': 'Loading 6–8 moderated results…',
