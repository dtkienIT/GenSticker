...
export default function PromptWorkspace() {
  ...
  return (
    <ScreenContainer scrollable>
      ...
      >
        <View style={styles.badgeRow}>
          ...
          <Text style={[typography.caption, { color: colors.textMuted }]}>
            {getStickerRuntimeMode() === 'mock' ? 'Local mock' : 'Native adapter'}
          </Text>
        </View>
        <Text style={[typography.h1, { color: colors.textPrimary }]}>Describe your sticker</Text>
        ...
        <View
          style={[
            styles.capability,
            {
              backgroundColor: capabilityStatus === 'ready' ? colors.primaryLight : colors.surface,
              borderRadius: borderRadius.md,
            },
          ]}
        >
          <View style={styles.capabilityCopy}>
            <Text style={[typography.bodyBold, { color: colors.textPrimary }]}>Device status</Text>
        ...
        <Text style={[typography.caption, { color: colors.textSecondary }]}>Try an example</Text>
      ...
      <View style={[styles.quickLinks, { marginVertical: spacing.lg }]}>
        <AppButton
          title={`My Stickers (${gallery.length})`}
          variant="secondary"
          onPress={() => router.push('/library')}
        />
        <AppButton title="Settings" variant="outline" onPress={() => router.push('/settings')} />
        {__DEV__ ? (
          <AppButton title="Diagnostics" variant="outline" onPress={() => router.push('/debug')} />
        ) : null}
      </View>
      ...
      {gallery.length === 0 ? (
        ...
        >
          ...
          <Text style={[typography.bodyBold, { color: colors.textPrimary }]}>No stickers yet</Text>
