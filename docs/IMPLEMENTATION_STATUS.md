...
| **F-013**  | Local universal sticker provider    | ✅ Completed | `backend/app/providers/universal_sticker_provider.py`                  |
...
- Local arbitrary-image sticker generation requires a downloaded BiRefNet snapshot
  configured through `BIREFNET_MODEL_PATH`.
