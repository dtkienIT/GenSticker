...
three use both the selfie and canonical as references and each create a strict
4-column by 2-row landscape sheet. The server crops the three sheets row by
row, keeps the 20 requested cells, and discards reserve cells from the final
sheet.

The original selfie and all three generated sheets remain available in the result view so
