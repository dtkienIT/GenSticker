...
from backend.app.api.v1.endpoints import assets, characters, cost, health, jobs, me, product
...
api_router.include_router(product.router, prefix="/api/v1", tags=["Sticker Product"])
